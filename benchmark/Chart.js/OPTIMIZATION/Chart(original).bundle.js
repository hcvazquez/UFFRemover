  ...
  compute it */
                ...
                module.exports = function (Chart) {
                    ...
                    Chart.controllers.doughnut = Chart.controllers.pie = Chart.DatasetController.extend({
                        ...
                        updateElement: function (arc, index, reset) {
                            var me = this;
                            var chart = me.chart, chartArea = chart.chartArea, opts = chart.options, animationOpts = opts.animation, arcOpts = opts.elements.arc, centerX = (chartArea.left + chartArea.right) / 2, centerY = (chartArea.top + chartArea.bottom) / 2, startAngle = opts.rotation,
                ...
                module.exports = function (Chart) {
                    ...
                    helpers.extend(Chart.Controller.prototype, {
                        ...
                        resize: function resize(silent) {
                            ...
                            Chart.pluginService.notifyPlugins('resize', [
                                me,
                                newSize
                            ]);
                            // Notify of resize
		 ...
		 */
                        ...
                        draw: function (ease) {
                            ...
                            Chart.pluginService.notifyPlugins('beforeDatasetDraw', [
                                me,
                                easingDecimal
                            ]);
                            ...
                            Chart.pluginService.notifyPlugins('afterDatasetDraw', [
                                me,
                                easingDecimal
                            ]);
                        ...
                        draw: function (chartArea) {
                            ...
                            if (me.isHorizontal()) {
                                ...
                                helpers.each(me.ticks, function (label, index) {
                                    ...
                                    var xLabelValue = me.getPixelForTick(index, gridLines.offsetGridLines);
                                ...
                                helpers.each(me.ticks, function (label, index) {
                                    ...
                                    if (optionTicks.display) {
                                        var xLabelValue;
                                        var yLabelValue = me.getPixelForTick(index, gridLines.offsetGridLines);
                                        // x values for optionTicks (need to consider offsetLabel option)
                                        context.save();
            ...
            function (require, module, exports) {
                ...
                module.exports = function (Chart) {
                    ...
                    Chart.Title = Chart.Element.extend({
                        ...
                        beforeFit: noop,
                        fit: function () {
                            var me = this, ctx = me.ctx, valueOrDefault = helpers.getValueOrDefault, opts = me.options, globalDefaults = Chart.defaults.global, display = opts.display, fontSize = valueOrDefault(opts.fontSize, globalDefaults.defaultFontSize), minSize = me.minSize;
                            if (me.isHorizontal()) {
                                minSize.width = me.maxWidth;
                                // fill all the width
                            ...
                            if (opts.display) {
                                ...
                                if (!opts.lineArc) {
                                    ...
                                    for (var i = me.getValueCount() - 1; i >= 0; i--) {
                                        ...
                                        var pointLabels = me.pointLabels, labelsCount = pointLabels.length, halfLabelsCount = pointLabels.length / 2, quarterLabelsCount = halfLabelsCount / 2, upperHalf = i < quarterLabelsCount || i > labelsCount - quarterLabelsCount, exactQuarter = i === quarterLabelsCount || i === labelsCount - quarterLabelsCount;
                                        if (i === 0) {
                                            ctx.textAlign = 'center';
