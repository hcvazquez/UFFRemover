            ...
            function (require, module, exports) {
                ...
                Chord.prototype = {
                    ...
                    voicing: function (voicing) {
                        ...
                        // Set the voicing
                        this._voicing = [];
                        for (var i = 0, length = voicing.length; i < length; i += 1) {
                    ...
                    get: function (interval) {
                        if (typeof interval === 'string' && interval in knowledge.stepNumber) {
                            ...
                            for (i = 0, length = intervals.length; i < length; i += 1) {
        ...
        6: [
            function (require, module, exports) {
                ...
                Scale.prototype = {
                    notes: function () {
                        var notes = [];
                        for (var i = 0, length = this.scale.length; i < length; i += 1) {
            ...
            function (require, module, exports) {
                ...
                module.exports = function (symbol) {
                    ...
                    function setChord(name) {
                        ...
                        for (var i = 0, len = intervals.length; i < len; i += 1) {
                    ...
                    for (var i = 0, len = symbol.length; i < len; i += 1) {
                        if (!(c = symbol[i])) {
                            return;
                        }
                        if (parsing === 'quality') {
                            ...
                            var alterations = symbol.substr(i).split(/(#|b|add|maj|sus|M)/i), next, flat = false, sharp = false;
                ...
                module.exports = function helmholtz(name) {
                    ...
                    if (octaveFirst) {
                        ...
                        if (octaveLast.match(/^'+$/) && lower) {
                            ...
                            throw new Error('Invalid formatting - mismatch between octave ' + 'indicator and letter case');
                        }
                    } else {
                        octave = lower ? 3 : 2;
                    }
